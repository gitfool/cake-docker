FROM mcr.microsoft.com/dotnet/sdk:5.0.203-focal
...
RUN curl -fsSL https://github.com/docker/compose/releases/download/1.29.1/docker-compose-$(uname -s)-$(uname -m) -o /usr/local/bin/docker-compose \
