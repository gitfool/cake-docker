FROM mcr.microsoft.com/dotnet/sdk:5.0.103-focal
...
RUN curl -fsSL https://download.docker.com/linux/static/stable/x86_64/docker-20.10.3.tgz | tar -zxO docker/docker > /usr/local/bin/docker \
